...
// 	}
	...
	triggerInputValidationEvent () {
		if ( this.fsm.triggerEvent ) {
			this.fsm.triggerEvent( 'ev_InputValidation_' + 'msk_n2_a_2a'.replace("msk_","") );
...
/***/ "./libs/numberLineWithAnnotations.js":
/*!*******************************************!*\
  !*** ./libs/numberLineWithAnnotations.js ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "numberLineWithAnnotations": () => (/* binding */ numberLineWithAnnotations)
/* harmony export */ });
/* harmony import */ var _common__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./common */ "./libs/common.js");
/* harmony import */ var _textFrame__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./textFrame */ "./libs/textFrame.js");
/* harmony import */ var _numberLine__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./numberLine */ "./libs/numberLine.js");
/* harmony import */ var konva_lib_Core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! konva/lib/Core */ "../node_modules/konva/lib/Core.js");
/* harmony import */ var konva_lib_shapes_Line__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! konva/lib/shapes/Line */ "../node_modules/konva/lib/shapes/Line.js");
...
class numberLineWithAnnotations {
	...
	constructor ( base, opts = {} ) {
		...
		this.numberLine = new _numberLine__WEBPACK_IMPORTED_MODULE_2__.numberLine( this.base_layer, opts.numberLine );
		...
		this.numberLine.kHitLine.on( "mouseenter touchmove", function(ev) {
			if ( this.sticky_ao  ) {
				...
				this.base.postLog( 'connLineCreated', {
					id: ao.logObjectId,
					toValue: this.numberLine.x2val( (0,_common__WEBPACK_IMPORTED_MODULE_3__.getXofEvent)( stage, ev ) ),
				});
	...
	delAllAnnotations () {
		...
		this.annot_layer = new konva_lib_Core__WEBPACK_IMPORTED_MODULE_0__["default"].Layer();
		this.stage.add( this.annot_layer );

		if ( this.line_layer ) {
			this.line_layer.destroy();
		}
		this.line_layer = new konva_lib_Core__WEBPACK_IMPORTED_MODULE_0__["default"].Layer();
	...
	setAnnotations ( annotations = [] ) {
		...
		annotations.forEach( a => {
			...
			// Frame
			ao.frame = new _textFrame__WEBPACK_IMPORTED_MODULE_4__.textFrame( this.base, this.annot_layer, {
					x: ao.x, y: ao.y,
			...
			ao.kLine = new konva_lib_Core__WEBPACK_IMPORTED_MODULE_0__["default"].Line({
				points: apoints,
			...
			ao.kAnnotationTick = new konva_lib_Core__WEBPACK_IMPORTED_MODULE_0__["default"].Line({
				points: apoints,
				stroke: ao.conLineColor,
				strokeWidth: ao.strokeWidth,
				lineCap: 'round',
	...
	getState () {
		...
		const state = (0,_common__WEBPACK_IMPORTED_MODULE_3__.delDefaults)( this.annotations, this.defaultAnnotation, [ "frame", "kLine", "kAnnotationTick" ] );
...
/* harmony import */ var _libs_numberLineWithAnnotations__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../libs/numberLineWithAnnotations */ "./libs/numberLineWithAnnotations.js");
...
const io = new _libs_numberLineWithAnnotations__WEBPACK_IMPORTED_MODULE_2__.numberLineWithAnnotations( base, {
	...
	annotations: [
		{ y: 50, toValue: 0, text: '0', annotationTickHeightBottom: 0, toValueReadonly: 1, textReadonly: 1, },
		{ y: 50, toValue: 100, text: '100', annotationTickHeightBottom: 0, toValueReadonly: 1, textReadonly: 1, },
		{ y: 50, toValue: 10, text: '', inputRegexp, annotationTickHeightBottom: 0, toValueReadonly: 1, },
		{ y: 50, toValue: 25, text: '', inputRegexp, annotationTickHeightBottom: 0, toValueReadonly: 1, },
		{ y: 50, toValue: 50, text: '', inputRegexp, annotationTickHeightBottom: 0, toValueReadonly: 1, },
		{ y: 50, toValue: 75, text: '', inputRegexp, annotationTickHeightBottom: 0, toValueReadonly: 1, },
		{ y: 50, toValue: 90, text: '', inputRegexp, annotationTickHeightBottom: 0, toValueReadonly: 1, },
	],

	statusVarDef: function () {
		const res = {
			[`V_Status_${varNam}_1`]: +( this.annotations[2].frame.value !== this.initData[2].label ),
			[`V_Status_${varNam}_2`]: +( this.annotations[3].frame.value !== this.initData[3].label ),
			[`V_Status_${varNam}_3`]: +( this.annotations[4].frame.value !== this.initData[4].label ),
			[`V_Status_${varNam}_4`]: +( this.annotations[5].frame.value !== this.initData[5].label ),
			[`V_Status_${varNam}_5`]: +( this.annotations[6].frame.value !== this.initData[6].label ),
		}
	...
	scoreDef: function () {
		...
		const vals = {};
		this.annotations.slice(2).forEach( v => vals[ v.toValue ] = v.frame.value );
		let erg = -2;

		const d1 = ( +vals[25] - +vals[10] );
		const d2 = ( +vals[50] - +vals[25] );
		const d3 = ( +vals[75] - +vals[50] );
		const d4 = ( +vals[90] - +vals[75] );

		if (	(0,_libs_common__WEBPACK_IMPORTED_MODULE_3__.isBetween)( +vals[10], 6, 15 ) &&
				(0,_libs_common__WEBPACK_IMPORTED_MODULE_3__.isBetween)( +vals[25], 20, 30 ) &&
				(0,_libs_common__WEBPACK_IMPORTED_MODULE_3__.isBetween)( +vals[50], 46, 56 ) &&
				(0,_libs_common__WEBPACK_IMPORTED_MODULE_3__.isBetween)( +vals[75], 70, 80 ) &&
				(0,_libs_common__WEBPACK_IMPORTED_MODULE_3__.isBetween)( +vals[90], 85, 94 ) &&
				(0,_libs_common__WEBPACK_IMPORTED_MODULE_3__.isBetween)( d1, 10, 20 ) &&
				(0,_libs_common__WEBPACK_IMPORTED_MODULE_3__.isBetween)( d2, 20, 30 ) &&
				(0,_libs_common__WEBPACK_IMPORTED_MODULE_3__.isBetween)( d3, 20, 30 ) &&
				(0,_libs_common__WEBPACK_IMPORTED_MODULE_3__.isBetween)( d4, 5, 15 ) ) 	erg = 1;

		else if ( Object.values( vals ).every( v => !v.length ) ) 	erg = -1;

		// else if ( Object.values( vals ).some( v => !v.length ) ) 	erg = -2;
		...
		return {
			[`V_Input_${varNam}_1`]: +( this.annotations[2].frame.value ),
			[`V_Input_${varNam}_2`]: +( this.annotations[3].frame.value ),
			[`V_Input_${varNam}_3`]: +( this.annotations[4].frame.value ),
			[`V_Input_${varNam}_4`]: +( this.annotations[5].frame.value ),
			[`V_Input_${varNam}_5`]: +( this.annotations[6].frame.value ),
			[`V_Score_${varNam}`]: erg,
		}
	},
});
...
/******/ })()
;
//# sourceMappingURL=msk_n2_a_2a.readable.js.map