...
// 	}
	...
	triggerInputValidationEvent () {
		if ( this.fsm.triggerEvent ) {
			this.fsm.triggerEvent( 'ev_InputValidation_' + 'msk_n2_a_3b'.replace("msk_","") );
...
const io = new _libs_numberLineWithAnnotations__WEBPACK_IMPORTED_MODULE_2__.numberLineWithAnnotations( base, {
	...
	numberLine: {
		...
		width: width,
		valFrom: -10, valTo: 1120,
		minTicks: { vals: 10, min: 0, max: null },
		midTicks: { vals: 50, min: 0, max: null },
		majTicks: { vals: 100, min: 0, max: null },
		labels: [ 0, [ 1000, '1 000' ] ],
		arrowDist: 30,
	},

	annotations: [
		{ y: 87, xval: 190, toValue: 100, text: '100', toValueReadonly: 1, textReadonly: 1, width: 60, },
		{ y: 81, xval: 330, text: '250', textReadonly: 1, width: 60, },
		{ y: 87, xval: 480, text: '490', textReadonly: 1, width: 60, },
		{ y: 81, xval: 620, text: '605', textReadonly: 1, width: 60, },
		{ y: 91, xval: 750, text: '899', textReadonly: 1, width: 60, },
		{ y: 87, xval: 880, text: '1010', textReadonly: 1, width: 60, },
	],

	statusVarDef: function () {
		const res = {
			[`V_Status_${varNam}_1`]: +( this.annotations[1].toValue !== this.initData[1].toValue ),
			[`V_Status_${varNam}_2`]: +( this.annotations[2].toValue !== this.initData[2].toValue ),
			[`V_Status_${varNam}_3`]: +( this.annotations[3].toValue !== this.initData[3].toValue ),
			[`V_Status_${varNam}_4`]: +( this.annotations[4].toValue !== this.initData[4].toValue ),
			[`V_Status_${varNam}_5`]: +( this.annotations[5].toValue !== this.initData[5].toValue ),
		}
	...
	scoreDef: function () {
		...
		const vals = {};
		this.annotations.slice(1).forEach( v => vals[ +v.text ] = v.toValue );
		let erg = -2;

		if (	(0,_libs_common__WEBPACK_IMPORTED_MODULE_3__.isBetween)( +vals[250], 245, 255 ) &&
				(0,_libs_common__WEBPACK_IMPORTED_MODULE_3__.isBetween)( +vals[490], 485, 495 ) &&
				(0,_libs_common__WEBPACK_IMPORTED_MODULE_3__.isBetween)( +vals[605], 601, 609 ) &&
				(0,_libs_common__WEBPACK_IMPORTED_MODULE_3__.isBetween)( +vals[899], 894, 900 ) &&
				(0,_libs_common__WEBPACK_IMPORTED_MODULE_3__.isBetween)( +vals[1010], 1005, 1015 ) ) 	erg = 1;
		else {
			...
			else if ( (0,_libs_common__WEBPACK_IMPORTED_MODULE_3__.isBetween)( +vals[605], 645, 655 ) ) 	erg = -3;

			else if ( (0,_libs_common__WEBPACK_IMPORTED_MODULE_3__.isBetween)( +vals[899], 885, 892 ) ) 	erg = -4;

			else if ( (0,_libs_common__WEBPACK_IMPORTED_MODULE_3__.isBetween)( +vals[1010], 1095, 1105 ) ) 	erg = -5;
		}

		return {
			[`V_Input_${varNam}_1`]: +( Math.round( this.annotations[1].toValue ) ),
			[`V_Input_${varNam}_2`]: +( Math.round( this.annotations[2].toValue ) ),
			[`V_Input_${varNam}_3`]: +( Math.round( this.annotations[3].toValue ) ),
			[`V_Input_${varNam}_4`]: +( Math.round( this.annotations[4].toValue ) ),
			[`V_Input_${varNam}_5`]: +( Math.round( this.annotations[5].toValue ) ),
			[`V_Score_${varNam}`]: erg,
		}
	},
});
...
/******/ })()
;
//# sourceMappingURL=msk_n2_a_3b.readable.js.map