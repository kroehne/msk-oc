...
// 	}
	...
	triggerInputValidationEvent () {
		if ( this.fsm.triggerEvent ) {
			this.fsm.triggerEvent( 'ev_InputValidation_' + 'msk_n2_a_3a'.replace("msk_","") );
...
const io = new _libs_numberLineWithAnnotations__WEBPACK_IMPORTED_MODULE_2__.numberLineWithAnnotations( base, {
	...
	annotations: [
		{ y: 75, toValue: 150, text: '', inputRegexp, toValueReadonly: 1, },
		{ y: 75, toValue: 370, text: '', inputRegexp, toValueReadonly: 1, },
		{ y: 75, toValue: 660, text: '', inputRegexp, toValueReadonly: 1, },
		{ y: 75, toValue: 890, text: '', inputRegexp, toValueReadonly: 1, },
		{ y: 75, toValue: 1100, text: '', inputRegexp, toValueReadonly: 1, },
	],

	statusVarDef: function () {
		const res = {
			[`V_Status_${varNam}_1`]: +( this.annotations[0].frame.value !== this.initData[0].label ),
			[`V_Status_${varNam}_2`]: +( this.annotations[1].frame.value !== this.initData[1].label ),
			[`V_Status_${varNam}_3`]: +( this.annotations[2].frame.value !== this.initData[2].label ),
			[`V_Status_${varNam}_4`]: +( this.annotations[3].frame.value !== this.initData[3].label ),
			[`V_Status_${varNam}_5`]: +( this.annotations[4].frame.value !== this.initData[4].label ),
		}
	...
	scoreDef: function () {
		...
		const vals = {};
		this.annotations.forEach( v => vals[ v.toValue ] = v.frame.value );
		let erg = -2;
		...
		else if (	vals[150] == 105 &&
				vals[370] == 307 &&
				vals[660] == 606 &&
				vals[890] == 809 &&
				vals[1100] == 1010 ) 	erg = -4;

		return {
			[`V_Input_${varNam}_1`]: +( this.annotations[0].frame.value ),
			[`V_Input_${varNam}_2`]: +( this.annotations[1].frame.value ),
			[`V_Input_${varNam}_3`]: +( this.annotations[2].frame.value ),
			[`V_Input_${varNam}_4`]: +( this.annotations[3].frame.value ),
			[`V_Input_${varNam}_5`]: +( this.annotations[4].frame.value ),
			[`V_Score_${varNam}`]: erg,
		}
	},
});
...
/******/ })()
;
//# sourceMappingURL=msk_n2_a_3a.readable.js.map