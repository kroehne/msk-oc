...
// 	}
	...
	triggerInputValidationEvent () {
		if ( this.fsm.triggerEvent ) {
			this.fsm.triggerEvent( 'ev_InputValidation_' + 'msk_n2_a_1a'.replace("msk_","") );
...
const io = new _libs_numberLineWithAnnotations__WEBPACK_IMPORTED_MODULE_2__.numberLineWithAnnotations( base, {
	...
	annotations: [
		{ y: 70, toValue: 0, text: '0', toValueReadonly: 1, annotationTickHeightBottom: 0, textReadonly: 1, },
		{ y: 70, toValue: 20, text: '', inputRegexp, annotationTickHeightBottom: 0, toValueReadonly: 1, },
		{ y: 70, toValue: 35, text: '', inputRegexp, annotationTickHeightBottom: 0, toValueReadonly: 1, },
		{ y: 70, toValue: 51, text: '', inputRegexp, annotationTickHeightBottom: 0, toValueReadonly: 1, },
		{ y: 70, toValue: 69, text: '', inputRegexp, annotationTickHeightBottom: 0, toValueReadonly: 1, },
		{ y: 70, toValue: 84, text: '', inputRegexp, annotationTickHeightBottom: 0, toValueReadonly: 1, },
		{ y: 70, toValue: 100, text: '100', annotationTickHeightBottom: 0, toValueReadonly: 1, textReadonly: 1, },
	],

	statusVarDef: function () {
		const res = {
			[`V_Status_${varNam}_1`]: +( this.annotations[1].frame.value !== this.initData[1].label ),
			[`V_Status_${varNam}_2`]: +( this.annotations[2].frame.value !== this.initData[2].label ),
			[`V_Status_${varNam}_3`]: +( this.annotations[3].frame.value !== this.initData[3].label ),
			[`V_Status_${varNam}_4`]: +( this.annotations[4].frame.value !== this.initData[4].label ),
			[`V_Status_${varNam}_5`]: +( this.annotations[5].frame.value !== this.initData[5].label ),
		}
	...
	scoreDef: function () {
		return {
			[`V_Input_${varNam}_1`]: +( this.annotations[1].frame.value ),
			[`V_Input_${varNam}_2`]: +( this.annotations[2].frame.value ),
			[`V_Input_${varNam}_3`]: +( this.annotations[3].frame.value ),
			[`V_Input_${varNam}_4`]: +( this.annotations[4].frame.value ),
			[`V_Input_${varNam}_5`]: +( this.annotations[5].frame.value ),
		}
	},
...
/******/ })()
;
//# sourceMappingURL=msk_n2_a_1a.readable.js.map