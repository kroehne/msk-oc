...
// 	}
	...
	triggerInputValidationEvent () {
		if ( this.fsm.triggerEvent ) {
			this.fsm.triggerEvent( 'ev_InputValidation_' + 'msk_s6_c_3b'.replace("msk_","") );
...
const io = new _libs_barSlider__WEBPACK_IMPORTED_MODULE_2__.barSlider_freePaint_freeLabels_insertButtons( base, {
	...
	scoreDef: function () {
		...
		if ( (0,_libs_common__WEBPACK_IMPORTED_MODULE_3__.isBetween)( this.pos, 82/100, 95/100 ) &&
			this.freeLabels[0].textObj.value.trim().match( /^0+ ?%$/ ) &&
			this.freeLabels[2].textObj.value.trim().match( /^0*90 ?%$/ ) &&
			this.freeLabels[4].textObj.value.trim().match( /^0*100 ?%$/ ) &&
			this.freeLabels[1].textObj.value.trim().match( /^0+$/ ) &&
			this.freeLabels[3].textObj.value.trim().match( /^0*918$/ ) &&
			this.freeLabels[5].textObj.value.trim().match( /^0*1020$/ ) )		return 1;

		if ( (0,_libs_common__WEBPACK_IMPORTED_MODULE_3__.object_equals)( this.getChState(), this.initData ) )		return -1;

		if ( (0,_libs_common__WEBPACK_IMPORTED_MODULE_3__.isBetween)( this.pos, 70/100, 82/100 ) ||
			(0,_libs_common__WEBPACK_IMPORTED_MODULE_3__.isBetween)( this.pos, 95/100, 100/100 ) )		return -3;

		if ( this.freeLabels[5].textObj.value.trim().length &&
			!this.freeLabels[5].textObj.value.trim().match( /^0*1020$/ ) )		return -4;
...
/******/ })()
;
//# sourceMappingURL=msk_s6_c_3b.readable.js.map