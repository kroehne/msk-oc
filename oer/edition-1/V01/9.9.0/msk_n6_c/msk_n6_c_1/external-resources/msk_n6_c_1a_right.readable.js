...
// 	}
	...
	triggerInputValidationEvent () {
		if ( this.fsm.triggerEvent ) {
			this.fsm.triggerEvent( 'ev_InputValidation_' + 'msk_n6_c_1a_right'.replace("msk_","") );
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "pointArea": () => (/* binding */ pointArea)
/* harmony export */ });
/* harmony import */ var _common__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./common */ "./libs/common.js");
/* harmony import */ var konva_lib_Core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! konva/lib/Core */ "../node_modules/konva/lib/Core.js");
/* harmony import */ var konva_lib_shapes_Rect__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! konva/lib/shapes/Rect */ "../node_modules/konva/lib/shapes/Rect.js");
...
/* harmony import */ var konva_lib_shapes_Line__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! konva/lib/shapes/Line */ "../node_modules/konva/lib/shapes/Line.js");
/* harmony import */ var _img_erasericon_png__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../img/erasericon.png */ "./img/erasericon.png");
/* harmony import */ var _img_clearicon_png__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../img/clearicon.png */ "./img/clearicon.png");
...
class pointArea {
	...
	constructor ( base, opts = {} ) {
		...
		const defaultOpts = {
			...
			iconBarDef: {
				...
				icons: [{
					src: _img_erasericon_png__WEBPACK_IMPORTED_MODULE_4__["default"],
					cursor: `url(${_img_erasericon_png__WEBPACK_IMPORTED_MODULE_4__["default"]}), auto`,
					on: () => {
						this.mode='erase';
					},
				},{
					src: _img_clearicon_png__WEBPACK_IMPORTED_MODULE_5__["default"],
					on: () => this.clearAll(),
				}],
			},
		...
		;(0,_common__WEBPACK_IMPORTED_MODULE_6__.mergeDeep)( Object.assign( this, defaultOpts ), opts );
		this.base = base;
		const stage = base.stage;
		this.stage = stage;

		const layer = new konva_lib_Core__WEBPACK_IMPORTED_MODULE_0__["default"].Layer();
		stage.add( layer );
		this.layer = layer;
		...
		if ( this.notMarkablePoints ) {
			...
			if ( p1 ) {
				...
				layer.add( new konva_lib_Core__WEBPACK_IMPORTED_MODULE_0__["default"].Rect({
					x: p1x,
					y: p1y,
		...
		// dost and rects
		this.dotGroup = new konva_lib_Core__WEBPACK_IMPORTED_MODULE_0__["default"].Group({});
		this.layer.add( this.dotGroup );
		this.drawAllDots();

		this.rectGroup = new konva_lib_Core__WEBPACK_IMPORTED_MODULE_0__["default"].Group({});
			...
			if ( idx>0 ) {
				...
				this.iconBarDef.icons.splice( -2, 0, {
					kCreateFunc: (x,y) => {
						...
						return new konva_lib_Core__WEBPACK_IMPORTED_MODULE_0__["default"].Rect({
							x: x+margin,
							y: y+margin,
							width: cw-2*margin,
							height: cw-2*margin,
		...
		this.iconBar = new _iconBar__WEBPACK_IMPORTED_MODULE_7__.iconBar( stage, this.iconBarDef );

		// interactivity
		if ( !this.readonly ) {
			const fgLayer = new konva_lib_Core__WEBPACK_IMPORTED_MODULE_0__["default"].Layer();
			stage.add( fgLayer );
			const kNewRect = new konva_lib_Core__WEBPACK_IMPORTED_MODULE_0__["default"].Rect({
			...
			stage.on( 'mousedown touchstart', (ev) => {
				if ( typeof this.mode === 'number' ) {
					...
					newRectStart = (0,_common__WEBPACK_IMPORTED_MODULE_6__.getPosOfEvent)( this.stage, ev );
			...
			stage.on( 'mouseup touchend', (ev) => {
				if ( this.newRect ) {
					const dim = calcDim( newRectStart, (0,_common__WEBPACK_IMPORTED_MODULE_6__.getPosOfEvent)( this.stage, ev ) );
					this.addNewRect( dim );
	...
	drawAllDots () {
		...
		for ( let row=0; row<this.rows; row++ ) {
			...
			for ( let col=0; col<this.cols; col++ ) {
				...
				if ( !kDot ) {
					kDot = new konva_lib_Core__WEBPACK_IMPORTED_MODULE_0__["default"].Circle({
						x, y,
		...
		if ( changed && !(0,_common__WEBPACK_IMPORTED_MODULE_6__.object_equals)( colorSums, this.reportedColorSums ) ) {
	...
	drawAllRects () {
		...
		this.colorRects.forEach( (r,idx) => {
			...
			const kRect = new konva_lib_Core__WEBPACK_IMPORTED_MODULE_0__["default"].Rect({
				x: r.x,
				y: r.y,
				width: r.w,
				height: r.h,
	...
	setState (state) {
		...
		(0,_common__WEBPACK_IMPORTED_MODULE_6__.setStatePostProc)(this);
	}
	...
	getDefaultChangeState () {
		return !(0,_common__WEBPACK_IMPORTED_MODULE_6__.object_equals)( this.getChState(), this.initData );
	}
...
/* harmony import */ var _libs_pointArea__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./libs/pointArea */ "./libs/pointArea.js");
...
const io = new _libs_pointArea__WEBPACK_IMPORTED_MODULE_2__.pointArea( base, {

	x, y,

	notMarkablePoints: 25,

////////////////////////////
	FSMVariableName: '1a_right',
//////////
//////////////////////////////
////////////////////////////////////////
//////////
...
/******/ })()
;
//# sourceMappingURL=msk_n6_c_1a_right.readable.js.map