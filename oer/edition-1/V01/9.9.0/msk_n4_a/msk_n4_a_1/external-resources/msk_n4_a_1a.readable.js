...
// 	}
	...
	triggerInputValidationEvent () {
		if ( this.fsm.triggerEvent ) {
			this.fsm.triggerEvent( 'ev_InputValidation_' + 'msk_n4_a_1a'.replace("msk_","") );
...
/////////////////////////////////
	scoreDef: function () {
		...
		if ( this.isMultRE( [[2,4],[4,2]], 8 ) ||
			this.isMultRE( [[2,4],[4,2]], 6 ) ||
			this.isSumRE( [[2,2,2]], 6 ) ) 	erg = -3;

		if ( this.isMultRE( [[2,2,2]], 8 ) ||
			this.isMultRE( [[2,2,2]], 6 ) ) 	erg = -4;

		return {
			[`V_Input_${'1a'}`]: this.extract(),
			[`V_Score_${'1a'}`]: erg,
		}
},
...
/******/ })()
;
//# sourceMappingURL=msk_n4_a_1a.readable.js.map