...
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (__webpack_require__.p + "demo_cursor.png");

/***/ }),

/***/ "./img/demo_cursor_click.png":
/*!***********************************!*\
  !*** ./img/demo_cursor_click.png ***!
  \***********************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (__webpack_require__.p + "demo_cursor_click.png");
...
// 	}
	...
	triggerInputValidationEvent () {
		if ( this.fsm.triggerEvent ) {
			this.fsm.triggerEvent( 'ev_InputValidation_' + 'msk_d2_b_1a_1'.replace("msk_","") );
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "demoAni": () => (/* binding */ demoAni)
/* harmony export */ });
...
/* harmony import */ var konva_lib_shapes_Image__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! konva/lib/shapes/Image */ "../node_modules/konva/lib/shapes/Image.js");
...
class demoAni {
	...
	constructor ( stage, aniDefs={} ) {
		...
		this.layer.add( new konva_lib_Core__WEBPACK_IMPORTED_MODULE_0__["default"].Rect({
			x:0, y:0,
...
// console.log( this.layer.find( () => true ).map( e => e.attrs.image.src ) )
	...
	loadCursor ( carr ) {
		...
		Object.keys( carr ).forEach( c => {
			...
			image.onload = () => {
				this.kCursor[c]	= new konva_lib_Core__WEBPACK_IMPORTED_MODULE_0__["default"].Image({ image });
			}
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "numberLine": () => (/* binding */ numberLine)
/* harmony export */ });
...
/* harmony import */ var konva_lib_shapes_Arrow__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! konva/lib/shapes/Arrow */ "../node_modules/konva/lib/shapes/Arrow.js");
/* harmony import */ var konva_lib_shapes_Circle__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! konva/lib/shapes/Circle */ "../node_modules/konva/lib/shapes/Circle.js");
/* harmony import */ var konva_lib_shapes_Text__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! konva/lib/shapes/Text */ "../node_modules/konva/lib/shapes/Text.js");
...
class numberLine {
	...
	constructor ( layer, opts = {} ) {
		...
		;(0,_common__WEBPACK_IMPORTED_MODULE_5__.mergeDeep)( Object.assign( this, defaultOpts, defTypeOpts[opts.type || 'ticks'] ), opts );
		this.layer = layer;
		...
		if ( this.lineHeight ) {
			...
			// this.numberLine
			layer.add( new konva_lib_Core__WEBPACK_IMPORTED_MODULE_0__["default"].Line( {
			...
			// arrow
			if ( this.arrowDist ) {
				layer.add( new konva_lib_Core__WEBPACK_IMPORTED_MODULE_0__["default"].Arrow({
					x: this.x+this.width,
					y: this.y,
					points: [ 0, 0, this.arrowDist, 0 ],
			...
			for ( let v=this.valFrom; v<this.valTo; v++ ) {
				layer.add( new konva_lib_Core__WEBPACK_IMPORTED_MODULE_0__["default"].Circle({
		...
		this.kHitLine = new konva_lib_Core__WEBPACK_IMPORTED_MODULE_0__["default"].Line( {
			points: [ this.x, this.y, this.x+this.width, this.y ],
	...
	writeLabel (v) {
		...
		if ( this.labelTickHeight ) {
			this.layer.add( new konva_lib_Core__WEBPACK_IMPORTED_MODULE_0__["default"].Line({
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "numberLineWithArcs": () => (/* binding */ numberLineWithArcs)
/* harmony export */ });
/* harmony import */ var _common__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./common */ "./libs/common.js");
/* harmony import */ var _textFrame__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./textFrame */ "./libs/textFrame.js");
/* harmony import */ var _numberLine__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./numberLine */ "./libs/numberLine.js");
/* harmony import */ var konva_lib_Core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! konva/lib/Core */ "../node_modules/konva/lib/Core.js");
/* harmony import */ var konva_lib_shapes_Line__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! konva/lib/shapes/Line */ "../node_modules/konva/lib/shapes/Line.js");
/* harmony import */ var konva_lib_shapes_Ellipse__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! konva/lib/shapes/Ellipse */ "../node_modules/konva/lib/shapes/Ellipse.js");
...
class numberLineWithArcs {
	...
	constructor ( base, opts = {} ) {
		...
		;(0,_common__WEBPACK_IMPORTED_MODULE_3__.mergeDeep)( Object.assign( this, defaults ), opts );
		this.base = base;
		const stage = base.stage;
		this.stage = stage;

		// NumberLine
		this.base_layer = new konva_lib_Core__WEBPACK_IMPORTED_MODULE_0__["default"].Layer();
		this.numberLine = new _numberLine__WEBPACK_IMPORTED_MODULE_4__.numberLine( this.base_layer, opts.numberLine );
...
// console.log("move",this.stage.getPointerPosition(),this.numberLine.y);
				...
				const absy = (0,_common__WEBPACK_IMPORTED_MODULE_3__.getYofEvent)( this.stage, ev );
				const absx = (0,_common__WEBPACK_IMPORTED_MODULE_3__.getXofEvent)( this.stage, ev );
...
// console.log("end move");
	...
	delAllArcs () {
		...
		this.arcs_layer = new konva_lib_Core__WEBPACK_IMPORTED_MODULE_0__["default"].Layer();
		this.stage.add( this.arcs_layer );

		this.arcs_group = new konva_lib_Core__WEBPACK_IMPORTED_MODULE_0__["default"].Group({
			clip: {
	...
	newTick (t) {
		...
		// Label
		if ( to.label!==null ) {
			to.labelObj = new _textFrame__WEBPACK_IMPORTED_MODULE_5__.textFrame( this.base, this.arcs_layer, {
				x: xa-to.width/2,
		...
		if ( this.tickFrameWidth ) {
			to.kLabelLine = new konva_lib_Core__WEBPACK_IMPORTED_MODULE_0__["default"].Line({
		...
		// Tick
		if ( to.tickHeight ) {
			to.kTick = new konva_lib_Core__WEBPACK_IMPORTED_MODULE_0__["default"].Line({
		...
		to.kHitTick = new konva_lib_Core__WEBPACK_IMPORTED_MODULE_0__["default"].Line({
...
// console.log("tickleave");
	...
	createNewTick ( event, val=null ) {
		...
		if ( val===null ) {
			const absx = (0,_common__WEBPACK_IMPORTED_MODULE_3__.getXofEvent)( this.stage, event );
...
// console.log("initTickMovable");
		to.orgPos = to.value;
		to.startX = (0,_common__WEBPACK_IMPORTED_MODULE_3__.getXofEvent)( this.stage, event );
		to.startY = (0,_common__WEBPACK_IMPORTED_MODULE_3__.getYofEvent)( this.stage, event );
	...
	newArc (a) {
		...
		if ( ao.label!==null ) {
			...
			ao.labelObj = new _textFrame__WEBPACK_IMPORTED_MODULE_5__.textFrame( this.base, this.arcs_layer, Object.assign( lo, {
				x: xm-lo.width/2,
		...
		// arc
		ao.kArc = new konva_lib_Core__WEBPACK_IMPORTED_MODULE_0__["default"].Ellipse({
			x: xm,
	...
	getState () {
		...
		const state = {
			arcs: (0,_common__WEBPACK_IMPORTED_MODULE_3__.delDefaults)( this.arcs, this.defaultArc, [ "labelObj", "kArc" ] ),
			ticks: (0,_common__WEBPACK_IMPORTED_MODULE_3__.delDefaults)( this.ticks, this.defaultTickLabel, [ 'labelObj', 'kLabelLine', 'kTick', 'kHitTick', ] ),
	...
	setState( state ) {
		...
		(0,_common__WEBPACK_IMPORTED_MODULE_3__.setStatePostProc)(this);
		this.getLastLog();
	}

	// Check if User made changes
	getDefaultChangeState () {
		return !(0,_common__WEBPACK_IMPORTED_MODULE_3__.object_equals)( this.getChState(), this.initData );
	}
	...
	reposTickTo ( to, color, event ) {
		...
		// get absolute x
		let absx = event ? (0,_common__WEBPACK_IMPORTED_MODULE_3__.getXofEvent)( this.stage, event ) : this.numberLine.val2x( to.value );
		// calc val
...
/* harmony import */ var _libs_numberLineWithArcs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../libs/numberLineWithArcs */ "./libs/numberLineWithArcs.js");
/* harmony import */ var _libs_demoAni__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../libs/demoAni */ "./libs/demoAni.js");
/* harmony import */ var _libs_common__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../libs/common */ "./libs/common.js");
/* harmony import */ var _img_demo_cursor_png__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../img/demo_cursor.png */ "./img/demo_cursor.png");
/* harmony import */ var _img_demo_cursor_click_png__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../img/demo_cursor_click.png */ "./img/demo_cursor_click.png");
...
const width = 790;
const io = new _libs_numberLineWithArcs__WEBPACK_IMPORTED_MODULE_2__.numberLineWithArcs( base, {
	...
	scoreDef: function () {
		...
		if (	(0,_libs_common__WEBPACK_IMPORTED_MODULE_3__.isBetween)( pos_3_12, 3.115, 3.125 ) &&
				(0,_libs_common__WEBPACK_IMPORTED_MODULE_3__.isBetween)( pos_3_6, 3.595, 3.605 ) ) 	erg = 1;

		else if ( this.ticks.length<2 || !this.ticks.every( t => t.label.length>0 ) ) 	erg = -1;
		else if ( this.ticks.length<2 ) 	erg = -2;

		else if ( this.ticks.some( v => (0,_libs_common__WEBPACK_IMPORTED_MODULE_3__.isBetween)( v.value, 4.195, 4.205 ) ) ) 	erg = -3;
...
const startDemoAni = false;		// demoAni is not displayed

const ani = startDemoAni && new _libs_demoAni__WEBPACK_IMPORTED_MODULE_4__.demoAni( base.stage, {
	repeats: 2,
	beginDelay: 300,
	...
	cursor: {
		demo: {	cursor: _img_demo_cursor_png__WEBPACK_IMPORTED_MODULE_5__["default"], cursorOfX: 8, cursorOfY: 3, },
		demo_click: { cursor: _img_demo_cursor_click_png__WEBPACK_IMPORTED_MODULE_6__["default"], cursorOfX: 21, cursorOfY: 18, }
	},
...
/******/ })()
;
//# sourceMappingURL=msk_d2_b_1a_1.readable.js.map