...
// 	}
	...
	triggerInputValidationEvent () {
		if ( this.fsm.triggerEvent ) {
			this.fsm.triggerEvent( 'ev_InputValidation_' + 'msk_d1_a_1a'.replace("msk_","") );
...
const io = new _libs_numberLineWithAnnotations__WEBPACK_IMPORTED_MODULE_2__.numberLineWithAnnotations( base, {
	...
	numberLine: {
		...
		minTicks: { vals: 0.01, min: 0, max: 1.02 },
	...
	scoreDef: function () {
		...
		if (	(0,_libs_common__WEBPACK_IMPORTED_MODULE_3__.isBetween)( vals[0], 0.1-tol, 0.1+tol ) &&
				(0,_libs_common__WEBPACK_IMPORTED_MODULE_3__.isBetween)( vals[1], 0.08-tol, 0.08+tol ) &&
				(0,_libs_common__WEBPACK_IMPORTED_MODULE_3__.isBetween)( vals[2], 0.67-tol, 0.67+tol ) ) 	erg = 1;

		else if ( vals.every( v => v===null ) ) erg = -1;

		else if ( vals.some( v => v===null ) ) erg = -2;

		else if (	(0,_libs_common__WEBPACK_IMPORTED_MODULE_3__.isBetween)( vals[0], 0.01-tol, 0.01+tol ) ||
				(0,_libs_common__WEBPACK_IMPORTED_MODULE_3__.isBetween)( vals[1], 0.8-tol, 0.8+tol ) ||
				(0,_libs_common__WEBPACK_IMPORTED_MODULE_3__.isBetween)( vals[2], 0.76-tol, 0.76+tol ) ) erg = -3;

		else if (	(0,_libs_common__WEBPACK_IMPORTED_MODULE_3__.isBetween)( vals[2], 0.7-tol, 0.7+tol ) ||
				(0,_libs_common__WEBPACK_IMPORTED_MODULE_3__.isBetween)( vals[2], 0.6-tol, 0.6+tol ) ) erg = -4;
...
/******/ })()
;
//# sourceMappingURL=msk_d1_a_1a.readable.js.map