...
// 	}
	...
	triggerInputValidationEvent () {
		if ( this.fsm.triggerEvent ) {
			this.fsm.triggerEvent( 'ev_InputValidation_' + 'msk_d1_a_1b'.replace("msk_","") );
...
const io = new _libs_numberLineWithAnnotations__WEBPACK_IMPORTED_MODULE_2__.numberLineWithAnnotations( base, {
	...
	annotations: [
		{ y: 110, xval: 0.15, toValue: 0.04, text: '', toValueReadonly: 1, width: 250, },
		{ y: 110, xval: 0.50, toValue: 0.53, text: '', toValueReadonly: 1, width: 250, },
		{ y: 110, xval: 0.85, toValue: 0.9, text: '', toValueReadonly: 1, width: 250, },
	],
	...
	statusVarDef: function () {
		...
		const res = {};
		res[`V_Status_${varNam}`] = +Object.values(tres).every( v => v>0 );
		return res;
	},
...
/******/ })()
;
//# sourceMappingURL=msk_d1_a_1b.readable.js.map