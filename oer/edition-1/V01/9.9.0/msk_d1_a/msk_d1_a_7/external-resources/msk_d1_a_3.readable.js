...
// 	}
	...
	triggerInputValidationEvent () {
		if ( this.fsm.triggerEvent ) {
			this.fsm.triggerEvent( 'ev_InputValidation_' + 'msk_d1_a_3'.replace("msk_","") );
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "connectedFrames": () => (/* binding */ connectedFrames)
/* harmony export */ });
/* harmony import */ var _common__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./common */ "./libs/common.js");
/* harmony import */ var _textFrame__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./textFrame */ "./libs/textFrame.js");
...
class connectedFrames {
	...
	constructor ( base, opts = {} ) {
		...
		if ( !this.readonly ) {
			...
			this.newline_layer = new konva_lib_Core__WEBPACK_IMPORTED_MODULE_0__["default"].Layer();
			this.stage.add( this.newline_layer );

			this.kNewLine = new konva_lib_Core__WEBPACK_IMPORTED_MODULE_0__["default"].Line({
				points: [],
			...
			this.stage.on( 'mousemove touchmove', (event) => {
				...
				if ( this.newConnFrom!==null ) {
					...
					if ( this.newConnTo!==null ) {
						...
						p2 = { 	x: (0,_common__WEBPACK_IMPORTED_MODULE_2__.getXofEvent)( this.stage, event ),
								y: (0,_common__WEBPACK_IMPORTED_MODULE_2__.getYofEvent)( this.stage, event ), };
					}
			...
			this.stage.on( 'mouseleave mouseup touchend', (event) => {
				if ( (0,_common__WEBPACK_IMPORTED_MODULE_2__.ignoreEvent)( this.stage, event ) ) {
					return;
				}
	...
	drawFrames () {
		...
		this.frame_layer = new konva_lib_Core__WEBPACK_IMPORTED_MODULE_0__["default"].Layer();
		...
		this.frames.forEach( ( f, nr ) => {
			...
			fo.textFrame = new _textFrame__WEBPACK_IMPORTED_MODULE_3__.textFrame( this.base, this.frame_layer, fo );
			this.frames[nr] = fo;
	...
	drawConnections () {
		...
		this.connections.forEach( ( c, nr ) => {
			...
			co.kConnection = new konva_lib_Core__WEBPACK_IMPORTED_MODULE_0__["default"].Line( co );
	...
	getState () {
		...
		const state = {
			...
			connections: (0,_common__WEBPACK_IMPORTED_MODULE_2__.delDefaults)( this.connections, this.defaultConnectionOpts, [ 'kConnection' ] ),
	...
	getDefaultChangeState () {
		return !(0,_common__WEBPACK_IMPORTED_MODULE_2__.object_equals)( this.getChState(), this.initData );
	}
...
/* harmony import */ var _libs_connectedFrames__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../libs/connectedFrames */ "./libs/connectedFrames.js");
...
const io = new _libs_connectedFrames__WEBPACK_IMPORTED_MODULE_2__.connectedFrames( base, {
...
/******/ })()
;
//# sourceMappingURL=msk_d1_a_3.readable.js.map