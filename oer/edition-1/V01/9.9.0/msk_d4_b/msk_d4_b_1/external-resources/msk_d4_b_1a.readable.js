...
// 	}
	...
	triggerInputValidationEvent () {
		if ( this.fsm.triggerEvent ) {
			this.fsm.triggerEvent( 'ev_InputValidation_' + 'msk_d4_b_1a'.replace("msk_","") );
...
///////////////////////////////////
	scoreDef: function () {
		if ( this.isMultRE( [ [ 5, 0.4 ], [ 0.4, 5 ] ], 2, true ) )		return 1;

		if ( !this.div.innerHTML.trim().length ) return -1;

		if ( this.isSumRE( [ [ 0.4, 0.4, 0.4, 0.4, 0.4 ] ], 2, true ) )		return -3;

		if ( this.isMultRE( this.allCombPerm( [ 0.4, 0.8, 1.2, 1.6, 2 ] ) ) )		return -4;

		if ( this.isMultRE( [ [ 5, 4 ], [ 4, 5 ] ] ) )		return -5;
...
/******/ })()
;
//# sourceMappingURL=msk_d4_b_1a.readable.js.map