...
// 	}
	...
	triggerInputValidationEvent () {
		if ( this.fsm.triggerEvent ) {
			this.fsm.triggerEvent( 'ev_InputValidation_' + 'msk_b2_b_1d'.replace("msk_","") );
...
(() => {
/*!****************************************!*\
  !*** ./batch_1/textInsert_rectArea.js ***!
  \****************************************/
__webpack_require__.r(__webpack_exports__);
...
/* harmony import */ var _libs_rectArea__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../libs/rectArea */ "./libs/rectArea.js");
...
const FSMVariableName = '1d';
const combinedStatus = [ 0, 0 ];
const combinedStatusName = `V_Status_${FSMVariableName}_Ext`;

const toolbarCellWidth = 30;

const ttBase = new _libs_baseInits__WEBPACK_IMPORTED_MODULE_2__.baseInits();
const ttWidth = window.innerWidth/2;

const ti = new _libs_textareaInserts__WEBPACK_IMPORTED_MODULE_3__.textareaInserts( '#tt', {

	toolbarDirection: 'row',
	divStyles: {
		width: `${ttWidth-2*toolbarCellWidth-4}px`,
	...
	toolbar: _libs_textareaInserts__WEBPACK_IMPORTED_MODULE_3__.toolbarMathOperatorsFraction,
...
const area = new _libs_rectArea__WEBPACK_IMPORTED_MODULE_4__.rectArea_freePaint( base, {

	x: 1, y: 1,
	width: ttWidth-10, height: base.height-1,

	modeIconBarDef: {
		x: ttWidth-10-32-2, y: 2,
		width: 32, height: 32,
		spacing: 0,
	},
...
/******/ })()
;
//# sourceMappingURL=msk_b2_b_1d.readable.js.map