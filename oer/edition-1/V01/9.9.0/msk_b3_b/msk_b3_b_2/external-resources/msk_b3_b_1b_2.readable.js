...
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (__webpack_require__.p + "clearicon.png");
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (__webpack_require__.p + "erasericon.png");
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (__webpack_require__.p + "markericon.png");
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (__webpack_require__.p + "penicon.png");
...
// 	}
	...
	triggerInputValidationEvent () {
		if ( this.fsm.triggerEvent ) {
			this.fsm.triggerEvent( 'ev_InputValidation_' + 'msk_b3_b_1b_2'.replace("msk_","") );
...
/* harmony import */ var _img_penicon_png__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../img/penicon.png */ "./img/penicon.png");
/* harmony import */ var _img_erasericon_png__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../img/erasericon.png */ "./img/erasericon.png");
/* harmony import */ var _img_clearicon_png__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../img/clearicon.png */ "./img/clearicon.png");
/* harmony import */ var _img_markericon_png__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../img/markericon.png */ "./img/markericon.png");
	...
	constructor ( base, opts = {} ) {
		...
		const additionalDefaultOpts = {
			...
			modeIconBarDef: {
				...
				icons: [
					{
						src: _img_penicon_png__WEBPACK_IMPORTED_MODULE_4__["default"],
						cursor: `url(${_img_penicon_png__WEBPACK_IMPORTED_MODULE_4__["default"]}), auto`,
						on: () => this.setPaintMode('brush'),	// overwritten by addFreePaint
						off: () => this.setPaintMode('none'),	// overwritten by addFreePaint
					},{
						src: _img_erasericon_png__WEBPACK_IMPORTED_MODULE_5__["default"],
						cursor: `url(${_img_erasericon_png__WEBPACK_IMPORTED_MODULE_5__["default"]}), auto`,
						on: () => this.setPaintMode('erase'),	// overwritten by addFreePaint
						off: () => this.setPaintMode('none'),	// overwritten by addFreePaint
					},{
						src: _img_clearicon_png__WEBPACK_IMPORTED_MODULE_6__["default"],
		...
		if ( hasMarker ) {
			additionalDefaultOpts.modeIconBarDef.icons.splice( 1, 0, {
				src: _img_markericon_png__WEBPACK_IMPORTED_MODULE_7__["default"],
				cursor: `url(${_img_markericon_png__WEBPACK_IMPORTED_MODULE_7__["default"]}), auto`,
...
const addFreeLabelsTo = ( baseClass ) => class extends baseClass {
	...
	getState () {
		...
		if ( this.freeLabels.length ) {
			...
			const state = JSON.parse( superState );
			state.freeLabels = this.freeLabels.map( l => l.readonly || !l.textObj.value.length ? {} : { value: l.textObj.value } );
			return JSON.stringify( state );
	...
	setState ( state ) {
		...
		try {
			...
			// merge Label-Defs
			if ( obj.freeLabels ) {
				obj.labels.forEach( ( l, n ) => Object.assign( this.freeLabels[n], l ) );
			}
			this.freeLabelsInit();
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "inputGrid": () => (/* binding */ inputGrid),
/* harmony export */   "inputGrid_InsertButtons": () => (/* binding */ inputGrid_InsertButtons),
/* harmony export */   "inputGrid_freePaint_InsertButtons": () => (/* binding */ inputGrid_freePaint_InsertButtons),
/* harmony export */   "inputGrid_freePaint_InsertButtons_grayOut": () => (/* binding */ inputGrid_freePaint_InsertButtons_grayOut),
/* harmony export */   "inputGrid_freePaint_InsertButtons_switch": () => (/* binding */ inputGrid_freePaint_InsertButtons_switch)
/* harmony export */ });
/* harmony import */ var _common__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./common */ "./libs/common.js");
/* harmony import */ var _iconBar__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./iconBar */ "./libs/iconBar.js");
/* harmony import */ var konva_lib_Core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! konva/lib/Core */ "../node_modules/konva/lib/Core.js");
/* harmony import */ var konva_lib_shapes_Rect__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! konva/lib/shapes/Rect */ "../node_modules/konva/lib/shapes/Rect.js");
/* harmony import */ var konva_lib_shapes_Line__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! konva/lib/shapes/Line */ "../node_modules/konva/lib/shapes/Line.js");
/* harmony import */ var konva_lib_shapes_Text__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! konva/lib/shapes/Text */ "../node_modules/konva/lib/shapes/Text.js");
/* harmony import */ var _img_clearicon_png__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../img/clearicon.png */ "./img/clearicon.png");
/* harmony import */ var _class_extensions__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./class_extensions */ "./libs/class_extensions.js");
/* harmony import */ var _img_penicon_png__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../img/penicon.png */ "./img/penicon.png");
...
class inputGrid {
	...
	constructor ( base, opts = {} ) {
			...
			textModeBarIconDefs: {
				...
				toggleLine: () => ({
					kCreateFunc: (function (x,y,iconBar) {
						return new konva_lib_Core__WEBPACK_IMPORTED_MODULE_0__["default"].Line({
				...
				textClearAll: () => ({
					src: _img_clearicon_png__WEBPACK_IMPORTED_MODULE_4__["default"],
		...
		;(0,_common__WEBPACK_IMPORTED_MODULE_5__.mergeDeep)( Object.assign( this, defaultOpts ), opts );
		this.base = base;
		...
		// fill data
		this.initialData = (0,_common__WEBPACK_IMPORTED_MODULE_5__.mergeDeep)( {}, this.data );
		...
		if ( this.textModeBarDefs ) {
			...
			if ( this.textModeBarDefs.icons.length ) {
				this.textModeBar = new _iconBar__WEBPACK_IMPORTED_MODULE_6__.iconBar( stage, this.textModeBarDefs );
			}
		}
		...
		const xEnd = this.x + w;
		const yEnd = this.y + h;
		this.kClickField = new konva_lib_Core__WEBPACK_IMPORTED_MODULE_0__["default"].Rect({
			x: this.x, y: this.y,
			width: w, height: h,
			opacity: 0,
		})
		...
		const events = {
			...
			'click tap': (ev) => {
				if ( this.mode=='text' || this.mode=='carry' ) {
					const cell = this.cellClip( this.getCell( (0,_common__WEBPACK_IMPORTED_MODULE_5__.getPosOfEvent)( this.stage, ev ) ) );
	...
	drawGrid () {
		...
		for ( let row=this.grid.rows+1; row--; ) {
			...
			this.layer.add( new konva_lib_Core__WEBPACK_IMPORTED_MODULE_0__["default"].Line( o ) );
		}
		...
		if ( ( cell.value.length || cell.style || cell.ul ) || ( cell.kText || cell.kUnderline ) ) {
			...
			if ( cell.value.length || cell.kText ) {
				if ( !cell.kText ) {
					...
					cell.kText = new konva_lib_Core__WEBPACK_IMPORTED_MODULE_0__["default"].Text( textStyles );
			...
			if ( cell.ul ) {
				...
				if ( !cell.kUnderline ) {
					cell.kUnderline = new konva_lib_Core__WEBPACK_IMPORTED_MODULE_0__["default"].Line({
 						points: [ x1, y, x2, y ],
						stroke: 'black',
						strokeWidth: 2,
					});
...
// else console.log( 'DOWN', ev );
	...
	setInputTo ( cursorPos, newValue=null ) {
		...
		const stageBox = (0,_common__WEBPACK_IMPORTED_MODULE_5__.getAbsPosition)( this.stage.container() );
	...
	getState () {
		...
		this.data.forEach( drow => {
			const row = drow.map( cell => (0,_common__WEBPACK_IMPORTED_MODULE_5__.delDefaults)( cell, this.cellDefaults, ['kText','kUnderline','width','offsX','cellsUsed','startX','startY','oldStyle'] ) );
	...
	getDefaultChangeState () {
		return !(0,_common__WEBPACK_IMPORTED_MODULE_5__.object_equals)( this.getChState(), this.initData );
	}
}
...
function inserButtonsDefFunc ( defs ) {
	(0,_common__WEBPACK_IMPORTED_MODULE_5__.mergeDeep)( defs.insertIconBarDef, {
...
const inputGrid_InsertButtons = (0,_class_extensions__WEBPACK_IMPORTED_MODULE_7__.addInsertButtonsTo)(
...
const inputGrid_freePaint_InsertButtons = (0,_class_extensions__WEBPACK_IMPORTED_MODULE_7__.addInsertButtonsTo)(

	// class to extend
	(0,_class_extensions__WEBPACK_IMPORTED_MODULE_7__.addFreePaintTo)(
		...
		function (defs) {
			...
			const padding = 1;
			(0,_common__WEBPACK_IMPORTED_MODULE_5__.mergeDeep)( defs.modeIconBarDef, {
...
class inputGrid_freePaint_InsertButtons_grayOut extends inputGrid_freePaint_InsertButtons {
...
class inputGrid_freePaint_InsertButtons_switch extends inputGrid_freePaint_InsertButtons {
	...
	constructor ( base, opts = {} ) {
			...
			switchModeBarDef.icons = [
				{
					...
					kCreateFunc: ( x, y ) => [
						...
						new konva_lib_Core__WEBPACK_IMPORTED_MODULE_0__["default"].Text( Object.assign( {}, defaultTextOptions, {
							text: 'A',
							fontSize: 20,
							align: "center",
							fontStyle: 'bold',
				...
				},
				{
					...
					kCreateFunc: ( x, y ) => [
						...
						new Promise( res => {
							...
							image.src = _img_penicon_png__WEBPACK_IMPORTED_MODULE_8__["default"];
						}).then( image => new konva_lib_Core__WEBPACK_IMPORTED_MODULE_0__["default"].Image({
							image,
							x: x+3,
							y: y+3,
							width: imgWidth-6,
		...
		this.switchModeBar = new _iconBar__WEBPACK_IMPORTED_MODULE_6__.iconBar( base.stage, switchModeBarDef );
		this.setAllOff();
...
/* harmony import */ var _libs_inputGrid__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./libs/inputGrid */ "./libs/inputGrid.js");
...
const width = base.width - Math.max( 2*cell.width*1.5, switchWidth ) - toolbarSpace - x - 2;
const height = base.height - y - 2;
...
/////////////////////////
////////////////////////
const insertButtonsY = y + switchOverAllHeight + ( [ "setTextMode", "toggleLine", "textClearAll" ].length + 0 ) * 1.5*cell.height + switchDist;
/////////
//////////////////////////////////////////////////////////////////////////////////
//////////
...
///////////////////////////
const ig = new _libs_inputGrid__WEBPACK_IMPORTED_MODULE_2__.inputGrid_freePaint_InsertButtons_switch( base, {
/////////
///////////////////////////////////////////////
//////////
	x, y,
...
////////////////////////
	textModeBarDefs: {
		x: iconBarX,
		y: y + switchOverAllHeight,
		iconDefs: [ "setTextMode", "toggleLine", "textClearAll" ],
	},
/////////
///////////////////
//////////////
...
/******/ })()
;
//# sourceMappingURL=msk_b3_b_1b_2.readable.js.map