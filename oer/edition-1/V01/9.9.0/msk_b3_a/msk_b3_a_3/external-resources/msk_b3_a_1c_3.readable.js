...
/* harmony export */   "bars_freePaint": () => (/* binding */ bars_freePaint)
/* harmony export */ });
...
class bars {
	...
	drawBackground () {
		...
		( Array.isArray(this.bars) ? this.bars : [this.bars] ).forEach( bar => {
			...
			this.layer.add( new konva_lib_Core__WEBPACK_IMPORTED_MODULE_0__["default"].Rect( barOpts ) );
			// segments
			if ( bar.segments ) {
		...
		this.labels.forEach( ( label, nr ) => {
			const labelObj = new _textFrame__WEBPACK_IMPORTED_MODULE_4__.textFrame(
				this.base,
				this.layer,
...
const bars_freePaint = (0,_class_extensions__WEBPACK_IMPORTED_MODULE_5__.addFreePaintTo)( bars, 1, 1 );
...
// 	}
	...
	triggerInputValidationEvent () {
		if ( this.fsm.triggerEvent ) {
			this.fsm.triggerEvent( 'ev_InputValidation_' + 'msk_b3_a_1c_3'.replace("msk_","") );
...
/* harmony import */ var _libs_bars__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../libs/bars */ "./libs/bars.js");
...
const io = new _libs_bars__WEBPACK_IMPORTED_MODULE_2__.bars_freePaint( base, {
...
/******/ })()
;
//# sourceMappingURL=msk_b3_a_1c_3.readable.js.map