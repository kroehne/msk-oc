...
// 	}
	...
	triggerInputValidationEvent () {
		if ( this.fsm.triggerEvent ) {
			this.fsm.triggerEvent( 'ev_InputValidation_' + 'msk_b1_b_1b_bottom'.replace("msk_","") );
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "filledBar": () => (/* binding */ filledBar)
/* harmony export */ });
...
class filledBar {
	...
	constructor ( base, opts = {} ) {
		...
		this.kMarkedRect = new konva_lib_Core__WEBPACK_IMPORTED_MODULE_0__["default"].Rect({
			x: this.x, y: this.y,
			width: 0, height: this.height,
			fill: this.markedColor,
		})
		this.markedLayer = new konva_lib_Core__WEBPACK_IMPORTED_MODULE_0__["default"].Layer();
		this.markedLayer.add( this.kMarkedRect );
		this.stage.add( this.markedLayer );

		// draw outer frame and ticks
		this.frameLayer = new konva_lib_Core__WEBPACK_IMPORTED_MODULE_0__["default"].Layer();
		...
		this.kOuterFrame = new konva_lib_Core__WEBPACK_IMPORTED_MODULE_0__["default"].Rect({
			x: this.x, y: this.y,
		...
		if ( !this.readonly ) {
			...
			this.kOuterFrame.on( 'mousedown touchstart', (ev) => {
				const v = this.x2valSticky( (0,_common__WEBPACK_IMPORTED_MODULE_3__.getXofEvent)( stage, ev ) );
			...
			this.stage.on( 'mousemove touchmove', (ev) => {
				if ( this.sticky ) {
					const x = (0,_common__WEBPACK_IMPORTED_MODULE_3__.getXofEvent)( stage, ev );
					if ( x < this.x ) {
						this.markedValue = 0;
					} else {
						const v = this.x2valSticky( (0,_common__WEBPACK_IMPORTED_MODULE_3__.getXofEvent)( stage, ev ) );
...
/* harmony import */ var _libs_filledBar__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../libs/filledBar */ "./libs/filledBar.js");
...
const io = new _libs_filledBar__WEBPACK_IMPORTED_MODULE_2__.filledBar( base, {
...
/******/ })()
;
//# sourceMappingURL=msk_b1_b_1b_bottom.readable.js.map