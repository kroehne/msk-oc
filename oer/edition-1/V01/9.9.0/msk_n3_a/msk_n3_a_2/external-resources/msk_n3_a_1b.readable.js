...
// 	}
	...
	triggerInputValidationEvent () {
		if ( this.fsm.triggerEvent ) {
			this.fsm.triggerEvent( 'ev_InputValidation_' + 'msk_n3_a_1b'.replace("msk_","") );
...
///////////////////////////////////
	scoreDef: function () {
		if ( this.isSumRE( [ [ 28, 13 ], [ 13, 28 ] ], 41, false ) )		return 1;

		if ( !this.div.innerHTML.trim().length ) return -1;

		if ( this.isSumRE( [ [ 28, 13 ], [ 13, 28 ] ], null ) )		return -3;

		if ( this.isSumRE( [ [ 28, 41 ], [ 41, 28 ] ] ) ||
			this.isSumRE( [ [ 41, 13 ], [ 13, 41 ] ] ) )		return -4;

		if ( this.isSumRE( [ [ 28, 13 ], [ 13, 28 ] ], 35, false ) )		return -5;
...
/******/ })()
;
//# sourceMappingURL=msk_n3_a_1b.readable.js.map