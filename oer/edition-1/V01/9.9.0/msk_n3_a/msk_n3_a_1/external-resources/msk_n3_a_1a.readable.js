...
// 	}
	...
	triggerInputValidationEvent () {
		if ( this.fsm.triggerEvent ) {
			this.fsm.triggerEvent( 'ev_InputValidation_' + 'msk_n3_a_1a'.replace("msk_","") );
...
///////////////////////////////////
	scoreDef: function () {
		if ( this.isSumRE( [ [ 35, 12 ], [ 12, 35 ] ], 47, false ) )		return 1;

		if ( !this.div.innerHTML.trim().length ) return -1;

		if ( this.isSumRE( [ [ 35, 12 ], [ 12, 35 ] ], null ) )		return -3;

		if ( this.isSumRE( [ [ 35, 47 ], [ 47, 35 ] ] ) ||
			this.isSumRE( [ [ 12, 47 ], [ 47, 12 ] ] ) )		return -4;
...
/******/ })()
;
//# sourceMappingURL=msk_n3_a_1a.readable.js.map