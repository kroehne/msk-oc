...
// 	}
	...
	triggerInputValidationEvent () {
		if ( this.fsm.triggerEvent ) {
			this.fsm.triggerEvent( 'ev_InputValidation_' + 'msk_n4_b_5a_right'.replace("msk_","") );
...
/////////////////////////////////////////
	scoreDef: function () {
		...
		if ( this.isDivRE( [[18,6]], 3 ) ||
			this.isDivRE( [[18,3]], 6 ) ) 	erg = 1;

		if ( !this.div.innerHTML.trim().length ) 	erg = -1;

		if ( this.isMultRE( [[3,6],[6,3]], 18 ) ) 	erg = -3;

		if ( this.isDivRE( [[10,20],[20,10]] ) ||
			this.isMultRE( [[10,20],[20,10]] ) ) 	erg = -4;

		if ( this.isDivRE( [[6,18]], 3 ) ||
			this.isDivRE( [[3,18]], 6 ) ) 	erg = -5;
...
///////////////////////////////////////
/////////////////////////////////////// different scoreDefinitions Batch_2
///////////////////////////////////////
...
/******/ })()
;
//# sourceMappingURL=msk_n4_b_5a_right.readable.js.map