...
// 	}
	...
	triggerInputValidationEvent () {
		if ( this.fsm.triggerEvent ) {
			this.fsm.triggerEvent( 'ev_InputValidation_' + 'msk_n4_b_5b'.replace("msk_","") );
...
/* harmony import */ var _img_demo_cursor_png__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../img/demo_cursor.png */ "./img/demo_cursor.png");
/* harmony import */ var _img_demo_cursor_click_png__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../img/demo_cursor_click.png */ "./img/demo_cursor_click.png");
/* harmony import */ var _libs_demoAni__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../libs/demoAni */ "./libs/demoAni.js");
...
const io = new _libs_numberLineWithArcs__WEBPACK_IMPORTED_MODULE_2__.numberLineWithArcs( base, {
	...
	scoreDef: function () {
		...
		if (	this.compArcs( [ [0,5], [5,10], [10,15], [15,20] ], tol ) ||
				this.compArcs( [ [0,4], [4,8], [8,12], [12,16], [16,20] ], tol ) ) return 1;

		if ( this.arcs.length===0 ) return -1;

		if (	this.compArcs( [ [0,4], [4,9] ], tol ) ||
				this.compArcs( [ [0,5], [5,9] ], tol ) ) return -3;

		const arc0from = this.arcs[0].from;
		if ( this.arcs.length==2 &&
				Math.abs( this.arcs[1].to - (arc0from+9) ) <= tol && (
					Math.abs( this.arcs[0].to - (arc0from+4) ) <= tol &&
					Math.abs( this.arcs[1].from - (arc0from+4) ) <= tol
				||
...
const ani = startDemoAni && new _libs_demoAni__WEBPACK_IMPORTED_MODULE_3__.demoAni( base.stage, {
	...
	cursor: {
		demo: {	cursor: _img_demo_cursor_png__WEBPACK_IMPORTED_MODULE_4__["default"], cursorOfX: 8, cursorOfY: 3, },
		demo_click: { cursor: _img_demo_cursor_click_png__WEBPACK_IMPORTED_MODULE_5__["default"], cursorOfX: 21, cursorOfY: 18, }
	},
...
/******/ })()
;
//# sourceMappingURL=msk_n4_b_5b.readable.js.map