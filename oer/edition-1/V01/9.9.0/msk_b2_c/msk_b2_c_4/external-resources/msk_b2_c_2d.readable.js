...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "barSlider": () => (/* binding */ barSlider),
/* harmony export */   "barSlider_freePaint": () => (/* binding */ barSlider_freePaint),
/* harmony export */   "barSlider_freePaint_freeLabels": () => (/* binding */ barSlider_freePaint_freeLabels),
/* harmony export */   "barSlider_freePaint_freeLabels_insertButtons": () => (/* binding */ barSlider_freePaint_freeLabels_insertButtons)
/* harmony export */ });
...
/* harmony import */ var _class_extensions__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./class_extensions */ "./libs/class_extensions.js");
...
class barSlider {
	...
	constructor ( base, opts = {} ) {
		...
		this.stage.on( 'mousemove touchmove', (ev) => {
			if ( this.sticky ) {
				this.setVal( Math.max( 0, Math.min( 1, this.x2val( (0,_common__WEBPACK_IMPORTED_MODULE_3__.getXofEvent)( this.stage, ev ) ) ) ) );
			}
		})
	...
	init () {
		...
		this.labels.forEach( l => {
			new _textFrame__WEBPACK_IMPORTED_MODULE_4__.textFrame( this.base, this.layer, {
		...
		// filled Rectangle
		this.kRectFilled = new konva_lib_Core__WEBPACK_IMPORTED_MODULE_0__["default"].Rect({
			x: this.x, y: this.y,
		...
		this.kSlider = new konva_lib_Core__WEBPACK_IMPORTED_MODULE_0__["default"].Line({
...
const barSlider_freePaint = (0,_class_extensions__WEBPACK_IMPORTED_MODULE_5__.addFreePaintTo)( barSlider, 0 );

const barSlider_freePaint_freeLabels = (0,_class_extensions__WEBPACK_IMPORTED_MODULE_5__.addFreeLabelsTo)( (0,_class_extensions__WEBPACK_IMPORTED_MODULE_5__.addFreePaintTo)( barSlider, 0 ) );

const barSlider_freePaint_freeLabels_insertButtons = (0,_class_extensions__WEBPACK_IMPORTED_MODULE_5__.addInsertButtonsTo)(
	// class to extend
	(0,_class_extensions__WEBPACK_IMPORTED_MODULE_5__.addFreeLabelsTo)( (0,_class_extensions__WEBPACK_IMPORTED_MODULE_5__.addFreePaintTo)( barSlider, 0 ) ),
...
// 	}
	...
	triggerInputValidationEvent () {
		if ( this.fsm.triggerEvent ) {
			this.fsm.triggerEvent( 'ev_InputValidation_' + 'msk_b2_c_2d'.replace("msk_","") );
...
/* harmony import */ var _libs_barSlider__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../libs/barSlider */ "./libs/barSlider.js");
...
const base = new _libs_baseInits__WEBPACK_IMPORTED_MODULE_1__.baseInits( {
	container: 'container',
...
dats.forEach( (dat,id) => {
	...
	ios.push( new _libs_barSlider__WEBPACK_IMPORTED_MODULE_2__.barSlider( base, {
...
/******/ })()
;
//# sourceMappingURL=msk_b2_c_2d.readable.js.map