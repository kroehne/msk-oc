...
// 	}
	...
	triggerInputValidationEvent () {
		if ( this.fsm.triggerEvent ) {
			this.fsm.triggerEvent( 'ev_InputValidation_' + 'msk_n2_c_2b'.replace("msk_","") );
...
const io = new _libs_numberLineWithArcs__WEBPACK_IMPORTED_MODULE_2__.numberLineWithArcs( base, {
	...
	arcHeight: 40,
	arcs: [
		{ from: 1700, to: 1800, 	arcReadonly: 1, },
		{ from: 1800, to: 1900, 	arcReadonly: 1, },
		{ from: 1900, to: 2000, 	arcReadonly: 1, },
	],
	...
	ticks: [
		...
		{ value: 1700,	label: "", 		width: 60, fontSize: 20, 	tickReadonly: 1, inputRegexp, },
		{ value: 1800,	label: "", 		width: 60, fontSize: 20, 	tickReadonly: 1, inputRegexp, },
		{ value: 1900,	label: '1900', 	width: 60, fontSize: 20, 	tickReadonly: 1, labelReadonly: 1 },
		{ value: 2000,	label: '2000', 	width: 60, fontSize: 20, 	tickReadonly: 1, labelReadonly: 1 },
	],
...
/******/ })()
;
//# sourceMappingURL=msk_n2_c_2b.readable.js.map