...
// 	}
	...
	triggerInputValidationEvent () {
		if ( this.fsm.triggerEvent ) {
			this.fsm.triggerEvent( 'ev_InputValidation_' + 'msk_s4_b_1'.replace("msk_","") );
...
const io = new _libs_barPlot__WEBPACK_IMPORTED_MODULE_2__.barPlot( base, {
	...
	statusVarDef: function () {
		...
		return {
			[`V_Status_${'1'}`]: +( bval3!==0 && bval4!==0 && btext1!=='' && btext5!=='' ),
		}
	},
	...
	scoreDef: function () {
		...
		if ( (0,_libs_common__WEBPACK_IMPORTED_MODULE_3__.isBetween)( bval3, 11.85, 12.15 ) &&
			(0,_libs_common__WEBPACK_IMPORTED_MODULE_3__.isBetween)( bval4, 6.85, 7.15 ) &&
			btext1 == 'Handball' &&
			btext5 == 'Reiten' )			erg = 1;

		else if ( bval3===0 && bval4===0 && btext1==='' && btext5==='' )	erg = -1;

		else if ( (0,_libs_common__WEBPACK_IMPORTED_MODULE_3__.isBetween)( bval4, 13.85, 14.15 ) ) 	erg = -3;

		else if ( (0,_libs_common__WEBPACK_IMPORTED_MODULE_3__.isBetween)( bval4, 5.85, 6.15 ) || (0,_libs_common__WEBPACK_IMPORTED_MODULE_3__.isBetween)( bval4, 7.85, 8.15 )) 	erg = -4;
		...
		return {
			[`V_Input_${'1'}_1`]: Math.round( bval3*100 ),
			[`V_Input_${'1'}_2`]: Math.round( bval4*100 ),
			[`V_Input_${'1'}_3`]: btext1,
			[`V_Input_${'1'}_4`]: btext5,
			[`V_Score_${'1'}`]: erg,
		}
	}
});
...
/******/ })()
;
//# sourceMappingURL=msk_s4_b_1.readable.js.map