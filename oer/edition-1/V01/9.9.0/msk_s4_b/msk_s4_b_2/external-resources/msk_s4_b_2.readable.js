...
// 	}
	...
	triggerInputValidationEvent () {
		if ( this.fsm.triggerEvent ) {
			this.fsm.triggerEvent( 'ev_InputValidation_' + 'msk_s4_b_2'.replace("msk_","") );
...
const io = new _libs_barPlot__WEBPACK_IMPORTED_MODULE_2__.barPlot( base, {
    ...
    statusVarDef: function () {
        return {
            [`V_Status_${'2'}`]: +this.yAxis.labelObjs.every( l => l.value ),
            [`V_Status_${'2'}_S`]: +this.yAxis.labelObjs.some( l => l.value ),
        }
	},

	scoreDef: function () {
		return {
			[`V_Input_${'2'}_1`]: +( this.yAxis.labelObjs[0].value ),
			[`V_Input_${'2'}_2`]: +( this.yAxis.labelObjs[1].value ),
			[`V_Input_${'2'}_3`]: +( this.yAxis.labelObjs[2].value ),
			[`V_Input_${'2'}_4`]: +( this.yAxis.labelObjs[3].value ),
			[`V_Input_${'2'}_5`]: +( this.yAxis.labelObjs[4].value ),
			[`V_Input_${'2'}_6`]: +( this.yAxis.labelObjs[5].value ),
		}
	}
...
/******/ })()
;
//# sourceMappingURL=msk_s4_b_2.readable.js.map