...
class barPlot {
	...
	constructor ( base, opts={} ) {
		...
		this.backgroundLayer = new konva_lib_Core__WEBPACK_IMPORTED_MODULE_0__["default"].Layer();
		this.stage.add( this.backgroundLayer );
		this.barLayer = new konva_lib_Core__WEBPACK_IMPORTED_MODULE_0__["default"].Layer();
		...
		if ( !this.readonly ) {
			...
			this.stage.on( 'mousemove touchmove', function (ev) {
				if ( this.sticky!==null ) {
					this.setVal( this.sticky, this.y2val( (0,_common__WEBPACK_IMPORTED_MODULE_3__.getYofEvent)( this.stage, ev ) ) );
				}
			}.bind(this) );
	...
	init () {
		...
		const addLine = ( defs, p ) => backLayer.add( new konva_lib_Core__WEBPACK_IMPORTED_MODULE_0__["default"].Line( Object.assign( {},
			defs, {
				points: p,
		})));
		...
		if ( this.titleObj ) {
			...
			this.titleObj = new _textFrame__WEBPACK_IMPORTED_MODULE_4__.textFrame( this.base, backLayer, Object.assign( {}, this.defaultTitleOpts, titleObj ) ) ;
		}
		...
		this.bars.forEach( ( bar, nr ) => {
			...
			// label
			const labelObj = new _textFrame__WEBPACK_IMPORTED_MODULE_4__.textFrame( this.base, backLayer, Object.assign(
				{},
			...
			// bar
			if ( !bar.readonly ) {
				backLayer.add( new konva_lib_Core__WEBPACK_IMPORTED_MODULE_0__["default"].Rect( Object.assign( {},
			...
			bar.kRect = new konva_lib_Core__WEBPACK_IMPORTED_MODULE_0__["default"].Rect( Object.assign( {},
				this.defaultBarOpts,
				bar, {
					x: x-this.barWidth/2,
					y: y,
			...
			if ( !this.readonly && !bar.readonly ) {
				...
				bar.kHitLine = new konva_lib_Core__WEBPACK_IMPORTED_MODULE_0__["default"].Line( Object.assign( {},
					this.defaultBarOpts, {
		...
		if ( this.yAxis.axisLabelObj ) {
			const labelObj = new _textFrame__WEBPACK_IMPORTED_MODULE_4__.textFrame( this.base, backLayer, Object.assign(
				...
				{
					x: x - this.defaultYLabelOpts.width - this.axisTickWidth - this.defaultYLabelOpts.distance
							- ( this.yAxis.axisLabelObj?.distance || this.defaultYAxisLabelOpts.distance )
	...
	getState () {
		...
		const state = {
			b: this.bars.map( b => {
				return b.readonly ? {} : {
					v: b.value,
					l: b.labelObj.readonly ? '' : b.labelObj.value,
				}
			}),
			l: this.yAxis.labelObjs.map( l => l.readonly ? '' : l.value ),
			a: !this.yAxis.axisLabelObj || this.yAxis.axisLabelObj.readonly ? '' : this.yAxis.axisLabelObj.value,
			t: !this.titleObj || this.titleObj.readonly ? '' : this.titleObj.value,
		};
	...
	setState (state) {
		...
		try {
			...
			// Restore labels & values
			load.b.forEach( ( b, nr ) => {
				this.bars[nr].value = b.v;
				if ( !this.bars[nr].readonly ) {
					this.bars[nr].labelObj.value = b.l;
				}
			});
			load.l.forEach( ( l, nr ) => {
				if ( !this.yAxis.labelObjs[ nr ].readonly ) {
					this.yAxis.labelObjs[ nr ].value = l;
				}
			})
			if ( this.yAxis.axisLabelObj && !this.yAxis.axisLabelObj.readonly ) {
				this.yAxis.axisLabelObj.value = load.a;
			}
			if ( this.titleObj && !this.titleObj.readonly ) {
				this.titleObj.value = load.t;
			}
...
// 	}
	...
	triggerInputValidationEvent () {
		if ( this.fsm.triggerEvent ) {
			this.fsm.triggerEvent( 'ev_InputValidation_' + 'msk_s4_b_3b'.replace("msk_","") );
...
/* harmony import */ var _libs_barPlot__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../libs/barPlot */ "./libs/barPlot.js");
...
const io = new _libs_barPlot__WEBPACK_IMPORTED_MODULE_2__.barPlot( base, {
	...
	scoreDef: function () {
		return {
			[`V_Input_${'3b'}_1`]: this.titleObj.value,
			[`V_Input_${'3b'}_2`]: this.yAxis.axisLabelObj.value,
			[`V_Input_${'3b'}_3`]: +( this.yAxis.labelObjs[0].value ),
			[`V_Input_${'3b'}_4`]: +( this.yAxis.labelObjs[1].value ),
			[`V_Input_${'3b'}_5`]: +( this.yAxis.labelObjs[2].value ),
			[`V_Input_${'3b'}_6`]: +( this.yAxis.labelObjs[3].value ),
			[`V_Input_${'3b'}_7`]: +( this.yAxis.labelObjs[4].value ),
			[`V_Input_${'3b'}_8`]: +( this.yAxis.labelObjs[5].value ),
			[`V_Input_${'3b'}_9`]: this.bars[0].labelObj.value,
			[`V_Input_${'3b'}_10`]: this.bars[1].labelObj.value,
			[`V_Input_${'3b'}_11`]: this.bars[2].labelObj.value,
			[`V_Input_${'3b'}_12`]: this.bars[3].labelObj.value,
			[`V_Input_${'3b'}_13`]: Math.round( ( this.bars[0].value || 0 ) * 100 ),
			[`V_Input_${'3b'}_14`]: Math.round( ( this.bars[1].value || 0 ) * 100 ),
			[`V_Input_${'3b'}_15`]: Math.round( ( this.bars[2].value || 0 ) * 100 ),
			[`V_Input_${'3b'}_16`]: Math.round( ( this.bars[3].value || 0 ) * 100 ),
		}
	}
...
/******/ })()
;
//# sourceMappingURL=msk_s4_b_3b.readable.js.map