...
// 	}
	...
	triggerInputValidationEvent () {
		if ( this.fsm.triggerEvent ) {
			this.fsm.triggerEvent( 'ev_InputValidation_' + 'msk_s6_a_1b'.replace("msk_","") );
...
const io = new _libs_barSlider__WEBPACK_IMPORTED_MODULE_2__.barSlider_freePaint( base, {
	...
	scoreDef: function () {
		return {
			[`V_Input_${this.FSMVariableName}`]: Math.round( this.pos * 1000 ),
		}
	}
})
...
/******/ })()
;
//# sourceMappingURL=msk_s6_a_1b.readable.js.map