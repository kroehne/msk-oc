...
// 	}
	...
	triggerInputValidationEvent () {
		if ( this.fsm.triggerEvent ) {
			this.fsm.triggerEvent( 'ev_InputValidation_' + 'msk_n1_a_2a_3'.replace("msk_","") );
...
const x = 15;
const width = 60*80/101;
const cwidth = 18*80/101;
const io = new _libs_numbersByPictures__WEBPACK_IMPORTED_MODULE_2__.numbersByPictures ( base, {
	x: x, y: (base.height-width-cwidth)/2+cwidth, width: base.width-x,
	pics: {
		width: width,
	},
	data: [
...
/******/ })()
;
//# sourceMappingURL=msk_n1_a_2a_3.readable.js.map