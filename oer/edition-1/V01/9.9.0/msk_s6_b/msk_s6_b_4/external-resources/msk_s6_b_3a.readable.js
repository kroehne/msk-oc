...
// 	}
	...
	triggerInputValidationEvent () {
		if ( this.fsm.triggerEvent ) {
			this.fsm.triggerEvent( 'ev_InputValidation_' + 'msk_s6_b_3a'.replace("msk_","") );
...
const io = new _libs_barSlider__WEBPACK_IMPORTED_MODULE_2__.barSlider_freePaint_freeLabels_insertButtons( base, {
	...
	scoreDef: function () {
		...
		if ( (0,_libs_common__WEBPACK_IMPORTED_MODULE_3__.isBetween)( this.pos, 62/100, 78/100 ) &&
			this.freeLabels[2].textObj.value.trim().match( /^0*70 ?%$/ ) &&
			this.freeLabels[3].textObj.value.trim().match( /^0*42(?: ?€)?$/ ) &&
			this.freeLabels[5].textObj.value.trim().match( /^0*60(?: ?€)?$/ ) )		return 1;

		if ( (0,_libs_common__WEBPACK_IMPORTED_MODULE_3__.object_equals)( this.getChState(), this.initData ) )		return -1;

		if ( (0,_libs_common__WEBPACK_IMPORTED_MODULE_3__.isBetween)( this.pos, 22/100, 38/100 ) ||
				( this.freeLabels[2].textObj.value.trim().match( /^0*30 ?%$/ ) &&
				this.freeLabels[3].textObj.value.trim().match( /^0*42(?: ?€)?$/ ) ) ||
			this.freeLabels[5].textObj.value.trim().match( /^0*140(?: ?€)?$/ ) )		return -3;

		if ( this.freeLabels[5].textObj.value.trim().match( /^0*72(?: ?€)?$/ ) )		return -4;

		if ( this.freeLabels[5].textObj.value.trim().match( /^0*70(?: ?€)?$/ ) )		return -5;
...
/******/ })()
;
//# sourceMappingURL=msk_s6_b_3a.readable.js.map