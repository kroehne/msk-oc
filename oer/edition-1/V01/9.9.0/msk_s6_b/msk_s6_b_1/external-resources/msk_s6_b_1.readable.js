...
// 	}
	...
	triggerInputValidationEvent () {
		if ( this.fsm.triggerEvent ) {
			this.fsm.triggerEvent( 'ev_InputValidation_' + 'msk_s6_b_1'.replace("msk_","") );
...
const io = new _libs_barSlider__WEBPACK_IMPORTED_MODULE_2__.barSlider_freePaint_freeLabels_insertButtons( base, {
	...
	scoreDef: function () {
		...
		if ( (0,_libs_common__WEBPACK_IMPORTED_MODULE_3__.isBetween)( this.pos, 15/100, 28/100 ) &&
			this.freeLabels[0].textObj.value.trim().match( /^(?:0+ ?%)?$/ ) &&
			this.freeLabels[2].textObj.value.trim().match( /^0*20 ?%$/ ) &&
			this.freeLabels[4].textObj.value.trim().match( /^(?:0*100 ?%)?$/ ) &&
			this.freeLabels[1].textObj.value.trim().match( /^(?:0+(?: ?[mM][bB])?)?$/ ) &&
			this.freeLabels[3].textObj.value.trim().match( /^0*8(?: ?[mM][bB])$/ ) &&
			this.freeLabels[5].textObj.value.trim().match( /^(?:0*40(?: ?[mM][bB])?)?$/ ) )		return 1;

		if ( (0,_libs_common__WEBPACK_IMPORTED_MODULE_3__.object_equals)( this.getChState(), this.initData ) )		return -1;

		if ( (0,_libs_common__WEBPACK_IMPORTED_MODULE_3__.isBetween)( this.pos, 72/100, 85/100 ) ||
			this.freeLabels[5].textObj.value.trim().match( /^0*10(?: ?[mM][bB])?$/ ) )	return -3;

		if ( !(0,_libs_common__WEBPACK_IMPORTED_MODULE_3__.isBetween)( this.pos, 15/100, 28/100 ) &&
			this.freeLabels[2].textObj.value.trim().match( /^0*20 ?%$/ ) &&
			this.freeLabels[3].textObj.value.trim().match( /^0*8(?: ?[mM][bB])?$/ ) )		return -4;
...
/******/ })()
;
//# sourceMappingURL=msk_s6_b_1.readable.js.map