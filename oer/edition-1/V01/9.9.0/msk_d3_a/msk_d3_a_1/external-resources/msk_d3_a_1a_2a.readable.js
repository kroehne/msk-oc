...
// 	}
	...
	triggerInputValidationEvent () {
		if ( this.fsm.triggerEvent ) {
			this.fsm.triggerEvent( 'ev_InputValidation_' + 'msk_d3_a_1a_2a'.replace("msk_","") );
...
//////////////////////////////////////
	scoreDef: function () {
		if ( this.isSumRE( this.perm( [ 3.5, 0.5, 0.08 ] ), 4.08, true ) )		return 1;

		if ( !this.div.innerHTML.trim().length ) return -1;

		if ( this.isSumRE( [ [ 3.5, 0.58 ], [ 0.58, 3.5 ] ], 4.08, true ) )		return -3;

		if ( this.isSumRE( [ [ 3.5, 0.5 ], [ 0.5, 3.5 ] ], 4, true ) ||
			this.isSumRE( [ [ 4, 0.08 ], [ 0.08, 4 ] ], 4.08, true ) )		return -4;

		if ( this.isSumRE( this.allCombPerm( [ 3.5, 4, 4.08 ] ) ) )		return -5;
...
/******/ })()
;
//# sourceMappingURL=msk_d3_a_1a_2a.readable.js.map