...
// 	}
	...
	triggerInputValidationEvent () {
		if ( this.fsm.triggerEvent ) {
			this.fsm.triggerEvent( 'ev_InputValidation_' + 'msk_d3_a_1a_1a'.replace("msk_","") );
...
//////////////////////////////////////
	scoreDef: function () {
		if ( this.isSumRE( [ [ 1.3, 0.6 ],[ 0.6, 1.3 ] ], 1.9, false ) )		return 1;

		if ( !this.div.innerHTML.trim().length ) return -1;

		if ( this.isSumRE( [ [1.3, 1.9], [ 1.9, 1.3 ] ], 0.6, false ) ||
			this.isSumRE( [ [1.3, 1.9], [ 1.9, 1.3 ] ], 3.2, false ) )		return -3;

		if ( this.isDiffRE( [ [ 1.9, 0.6 ] ], 1.3, false ) )	return -4;

		if ( this.isDiffRE( [ [ 1.9, 1.3 ], [ 1.3, 1.9 ] ], 0.6, false ) ||
			this.isDiffRE( [ [ 0.6, 1.9 ] ], 1.3, false ) )	return  -5
...
/******/ })()
;
//# sourceMappingURL=msk_d3_a_1a_1a.readable.js.map