...
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (__webpack_require__.p + "child.png");
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (__webpack_require__.p + "pen.png");
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (__webpack_require__.p + "pen_32.png");
...
// 	}
	...
	triggerInputValidationEvent () {
		if ( this.fsm.triggerEvent ) {
			this.fsm.triggerEvent( 'ev_InputValidation_' + 'msk_n4_b_1a_2'.replace("msk_","") );
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "stampImages": () => (/* binding */ stampImages)
/* harmony export */ });
/* harmony import */ var _common__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./common */ "./libs/common.js");
/* harmony import */ var _iconBar__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./iconBar */ "./libs/iconBar.js");
/* harmony import */ var konva_lib_Core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! konva/lib/Core */ "../node_modules/konva/lib/Core.js");
/* harmony import */ var konva_lib_shapes_Rect__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! konva/lib/shapes/Rect */ "../node_modules/konva/lib/shapes/Rect.js");
...
/* harmony import */ var _img_pen_png__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../img/pen.png */ "./img/pen.png");
/* harmony import */ var _img_pen_32_png__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../img/pen_32.png */ "./img/pen_32.png");
...
class stampImages {
	...
	constructor ( base, opts = {} ) {
		...
		;(0,_common__WEBPACK_IMPORTED_MODULE_3__.mergeDeep)( Object.assign( this, defaultOpts ), opts );
		this.base = base;
		...
		this.stage.on( 'mousemove touchmove', (ev) => {
			if ( this.kDragObj ) {
				this.kDragObj.x( (0,_common__WEBPACK_IMPORTED_MODULE_3__.getXofEvent)( this.stage, ev )-this.dragOffsX );
				this.kDragObj.y( (0,_common__WEBPACK_IMPORTED_MODULE_3__.getYofEvent)( this.stage, ev )-this.dragOffsY );
				this.layer.batchDraw();
			} else {
				this.movePaint( ev )
			}
		...
		this.stage.on( 'mouseup mouseleave touchend', (ev) => {
			...
			if ( this.kDragObj ) {
				...
				const x = (0,_common__WEBPACK_IMPORTED_MODULE_3__.getXofEvent)( this.stage, ev );
	...
	init () {
		...
		icons.push({
			src: _img_pen_png__WEBPACK_IMPORTED_MODULE_4__["default"],
			cursor: `url(${_img_pen_32_png__WEBPACK_IMPORTED_MODULE_5__["default"]}) 3 32, auto`,
			on: () => this.isPen = 1,
			off: () => this.isPen = 0,
		})
		icons.push({
		...
		this.iconBar = new _iconBar__WEBPACK_IMPORTED_MODULE_7__.iconBar( this.stage, {
			x: this.iconBarX,
			y: this.iconBarY,
	...
	dragIcon ( i, ev ) {
		...
		kDragObj.stampId = i;
		this.dragOffsX = (0,_common__WEBPACK_IMPORTED_MODULE_3__.getXofEvent)( this.stage, ev ) - kDragObj.x();
		this.dragOffsY = (0,_common__WEBPACK_IMPORTED_MODULE_3__.getYofEvent)( this.stage, ev ) - kDragObj.y();
	...
	startPaint (ev) {
		if ( !this.isPainting && this.isPen ) {
			const xa = (0,_common__WEBPACK_IMPORTED_MODULE_3__.getXofEvent)( this.stage, ev );
			if ( xa <= this.iconBarX-5 ) {
				this.isPainting = 1;

				this.paintLine = new konva_lib_Core__WEBPACK_IMPORTED_MODULE_0__["default"].Line( Object.assign( {}, this.lineSettings, {
					points: [ (0,_common__WEBPACK_IMPORTED_MODULE_3__.getXofEvent)( this.stage, ev ), (0,_common__WEBPACK_IMPORTED_MODULE_3__.getYofEvent)( this.stage, ev ) ],
				}) );
	...
	movePaint (ev) {
		if ( this.isPainting ) {
			...
			if ( xa > this.iconBarX-5 ) {
				...
				const ya = (0,_common__WEBPACK_IMPORTED_MODULE_3__.getYofEvent)( this.stage, ev );
	...
	loadState ( state ) {
		...
		try {
			...
			load.lines.forEach( l => {
				this.kGroup.add( new konva_lib_Core__WEBPACK_IMPORTED_MODULE_0__["default"].Line( Object.assign( {}, this.lineSettings, {
					points: l,
				}) ) );
			});
...
/* harmony import */ var _libs_stampImages__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../libs/stampImages */ "./libs/stampImages.js");
/* harmony import */ var _libs_demoAni__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../libs/demoAni */ "./libs/demoAni.js");
/* harmony import */ var _img_child_png__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../img/child.png */ "./img/child.png");
/* harmony import */ var _img_dot_png__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../img/dot.png */ "./img/dot.png");
/* harmony import */ var _img_demo_cursor_png__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../img/demo_cursor.png */ "./img/demo_cursor.png");
/* harmony import */ var _img_demo_cursor_click_png__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../img/demo_cursor_click.png */ "./img/demo_cursor_click.png");
...
const iconBarY = 2;
const io = new _libs_stampImages__WEBPACK_IMPORTED_MODULE_2__.stampImages( base, {

	x: 0, y: 0,
	width: base.width, height: base.height,
	iconBarX, iconBarY,

	stamps: [ _img_child_png__WEBPACK_IMPORTED_MODULE_3__["default"], _img_dot_png__WEBPACK_IMPORTED_MODULE_4__["default"] ],

	FSMVariableName: '1a_drawing',
} );
...
const ani = startDemoAni && new _libs_demoAni__WEBPACK_IMPORTED_MODULE_5__.demoAni( base.stage, {
	repeats: 2,
	beginDelay: 300,
	...
	cursor: {
		demo: {	cursor: _img_demo_cursor_png__WEBPACK_IMPORTED_MODULE_6__["default"], cursorOfX: 8, cursorOfY: 3, },
		demo_click: { cursor: _img_demo_cursor_click_png__WEBPACK_IMPORTED_MODULE_7__["default"], cursorOfX: 21, cursorOfY: 18, }
	},
...
/******/ })()
;
//# sourceMappingURL=msk_n4_b_1a_2.readable.js.map