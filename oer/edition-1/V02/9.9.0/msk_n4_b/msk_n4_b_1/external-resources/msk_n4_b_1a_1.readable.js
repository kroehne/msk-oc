...
// 	}
	...
	triggerInputValidationEvent () {
		if ( this.fsm.triggerEvent ) {
			this.fsm.triggerEvent( 'ev_InputValidation_' + 'msk_n4_b_1a_1'.replace("msk_","") );
...
/////////////////////////////////////
	scoreDef: function () {
		...
		if ( this.isDivRE( [[12,3]], 4, false ) ) erg = 1;

		else if ( !this.div.innerHTML.trim().length ) erg = -1;

		else if ( this.isDivRE( [[8,4],[4,8]], 12, false ) ||
			this.isDivRE( [[12,4]], 8, false ) ||
			this.isDivRE( [[12,8]], 4, false ) ) erg = -3;

		else if ( this.isDivRE( [[3,12]], 4, false ) ) erg = -4;

		else if ( this.div.innerHTML.trim()=='4' ) erg = -5;

		else if ( this.isDivRE( [[12,4]], 3, false ) ) erg = -6;

		else if ( this.isMultRE( [[3,4],[4,3]], 12 ) ) erg = -7;

		else erg = -2;

		return {
			'V_Input_1a_1': this.extract(),
			'V_Score_1a_1': erg,
		}
	},
...
/******/ })()
;
//# sourceMappingURL=msk_n4_b_1a_1.readable.js.map