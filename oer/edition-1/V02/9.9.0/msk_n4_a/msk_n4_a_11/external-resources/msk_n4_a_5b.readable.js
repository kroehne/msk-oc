...
// 	}
	...
	triggerInputValidationEvent () {
		if ( this.fsm.triggerEvent ) {
			this.fsm.triggerEvent( 'ev_InputValidation_' + 'msk_n4_a_5b'.replace("msk_","") );
...
/////////
	scoreDef: function () {
		...
		if (	this.compArcs( [ [0,3], [3,8] ], tol ) ||
				this.compArcs( [ [0,5], [5,8] ], tol ) ||
				this.compArcs( [ [0,3], [3,8], [8,15] ], tol ) ||
				this.compArcs( [ [0,5], [5,8], [8,15] ], tol ) ) return -3;
		...
		if (	this.compArcs( [ [0,3], [3,5] ], tol ) ) 	return -5
...
/******/ })()
;
//# sourceMappingURL=msk_n4_a_5b.readable.js.map