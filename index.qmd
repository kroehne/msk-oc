...
msk_label <- data.frame(Module =  c("msk_b1_a","msk_b1_b","msk_b1_c","msk_b2_a", 
                                    ...
                                    "msk_n2_c","msk_n3_a","msk_n4_a","msk_n4_b",  
                                    "msk_n5_a","msk_n6_a","msk_n6_b","msk_n6_c",
                                    ...
                                    "msk_s6_c","msk_n3_a_auflage2","msk_n4_a_auflage2","msk_n4_b_auflage2"), 
                        Label=c("B1A","B1B","B1C","B2A","B2B","B2C","B3A","B3B","B4A",
                                ...
                                "S6B","S6C","N3A (2. Aufl.)","N4A (2. Aufl.)","N4B (2. Aufl.)")) 
...
info <- info %>% arrange(Baustein, Version)
result <- info %>%
  group_by(Baustein) %>%
  mutate(Baustein = replace(Baustein, duplicated(Baustein), '')) %>%
  ungroup %>%
  mutate(Thema = replace(Thema, duplicated(Thema), '')) %>% select(Thema,Baustein,Version,ItemBuilder)
colnames(result) <-c("Thema des Bausteins", "Baustein", "Version", "CBA ItemBuilder")
knitr::kable(result)
